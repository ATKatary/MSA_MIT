        ...
        right.push(
            {
                ...
                content: {
                    ...
                    >
                       {section.icon? <section.icon style={{margin: "0 10px 0 0"}}/> : <></>} {section.name.toUpperCase().replace("-", " ")} 
                    </Link>
                }
            },
        )
        ...
        NAV_LEFT: [
            {
                meta: {
                    ...
                    style: {margin: "0 0 10px 0", display: "flex", flexDirection: "column"},
                },
                content: {
                    title: <img src={logo} height="50px" className="pointer align-self-center"/>
                }
            },
